...
const highlightWitthPrism = (code: string) => {
...
const CustomCodeEditor: React.FC<CustomCodeEditorProps> = ({
  ...
  return (
    <div className="relative lg:w-4/6 w-full mx-auto">
      <div
        className="border outline-none border-r-2 rounded-2xl p-6 bg-neutral-900 text-neutral-200
       border-neutral-700"
      ...
      >
        <Editor
          ...
          highlight={(code) => highlightWitthPrism(code)}
          padding={15}
